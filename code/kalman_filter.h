...
#define mat Matrix
#define Matrix_Init Matrix_init
#define Matrix_Add Matrix_add
#define Matrix_Subtract Matrix_sub
#define Matrix_Multiply Matrix_mult
#define Matrix_Transpose Matrix_trans
#define Matrix_Inverse Matrix_inverse
