...
uint8 imu963ra_init (void)
{
    ...
    spi_init(IMU963RA_SPI, SPI_MODE0, IMU963RA_SPI_SPEED, IMU963RA_SPC_PIN, IMU963RA_SDI_PIN, IMU963RA_SDO_PIN, SPI0_CS2_P20_13);
#endif
    ...
    do
    {
        ...
        //imu963ra_write_acc_gyro_register(IMU963RA_CTRL1_XL, 0x3C);              // 设置加速度计量程±8G以及数据输出速率52hz 以及加速度信息从第一级滤波器输出
        imu963ra_write_acc_gyro_register(IMU963RA_CTRL1_XL, 0x8C); //1.66K
        //imu963ra_write_acc_gyro_register(IMU963RA_CTRL1_XL, 0x84); //1.66K
        ...
        //imu963ra_write_acc_gyro_register(IMU963RA_CTRL2_G, 0x5C);               // 设置陀螺仪计量程 ±2000dps 以及数据输出速率 208hz
        imu963ra_write_acc_gyro_register(IMU963RA_CTRL2_G, 0x8C); //1.66k
        //imu963ra_write_acc_gyro_register(IMU963RA_CTRL2_G, 0x81); //1.66k 4000
